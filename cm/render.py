...
; way to run one model, and its name says which: the window in thousands of tokens, the
; attention cache, -mtp where a prediction head drafts ahead, and -rpc where it needs the
; card of another machine, lent through that machine's worker.
;
...
def preset(config: Config, machine: Machine, memory: SystemMemory,
    ...
    be keyed anything at all -- `qwen3.8-45k-q8` is a legal key, and it collides with a
